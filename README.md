...
### These COVID-19 samples from Covid-Chestxray-Dataset are extracted from several publications. 
### Only the posterior-anterior images have been used for the dataset. 
### Also, the X-ray images of COVID-19 samples have been verified by board-certified radiologist for the credibility of dataset.
